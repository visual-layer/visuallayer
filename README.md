...
| [KITTI](./dataset_card/kitti/card.md)                          | <ul><li>Duplicates - 15.29% (2,294)</li><li>Outliers - 0.01% (2)</li><li>Leakage - 6.01% (452)</li><b>Total</b> - 21.32% (2,748)</li></ul><div align="right"><a href="./dataset_card/kitti/card.md"><strong>More »</strong></a></div> | Request access [here](https://forms.gle/8jxPkyzeKj82kPed8).                                        | WIP                  |
