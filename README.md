...
| [Imagenet-1k](https://www.image-net.org/)                               | <ul><li>Duplicates - WIP % (WIP)</li><li>Outliers - WIP % (WIP)</li><li>Broken - WIP % (WIP)</li><li>Blur - WIP % (WIP)</li><li>Dark - WIP % (WIP)</li><li>Bright - WIP % (WIP)</li></ul> | Request access [here](https://forms.gle/8jxPkyzeKj82kPed8).                                        | WIP                  |
...
| [CelebA-HQ](http://mmlab.ie.cuhk.edu.hk/projects/CelebA.html)           | <ul><li>Duplicates - 1.673 % (3389)</li><li>Outliers - 0.077 % (157)</li><li>Broken - 0.000 % (0)</li><li>Blur - 0.512 % (1037)</li><li>Dark - 0.009 % (18)</li><li>Bright - 0.000 % (0)</li><li>Mislabeled - 0.006 % (13)</li><li><b>Total</b> - 2.277 % (4614)</li></ul> | Request access [here](https://forms.gle/8jxPkyzeKj82kPed8).                                        | WIP                  |
